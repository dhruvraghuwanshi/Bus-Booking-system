...
class bus_booking:
    ...
    def home_page(self):
        ...
        Label(root, text="Online Bus Booking System", font='Arial 20 bold', bg='yellow', fg='black').grid(row=2,
                                                                                                            column=2,
                                                                                                            columnspan=9,
                                                                                                            padx=w // 2.5)
    ...
    def cover_page(self):
        ...
        Label(root, text="Online Bus Booking System", font='Arial 20 bold', bg='yellow', fg='black').pack()
        Label(root, text="\n\n\n\n\nName: RAGHU RAGHUWANSHI", font='Arial 16 bold', fg='black').pack()
        Label(root, text="\nEnr : 211B238", font='Arial 16 bold', fg='black').pack()
        Label(root, text="\nMobile : 9617429518\n\n\n\n", font='Arial 16 bold', fg='black').pack()
        Label(root, text="Submitted to: Dr. Mahesh Kumar", font='Arial 15 bold', bg='yellow', fg='black').pack()
        Label(root, text="Project Based Learning", font='Arial 15 bold', fg='black').pack()
                                            ...
                                            if len(name)>0 and len(name)<20:
                                                if age>0 and age<150:
                                                    if seats>0 and seats<101:
                                                        ...
                                                        showerror("booking limit exceed","you can only book upto 100 seats")
                                                else:
    ...
    def check_booking_page(self):
        ...
        def check_tkt():
            ...
            if len(mobile)==10 and mobile.isdigit():
                ...
                fr.grid(row=6,columnspan=12)
                Label(fr,text="booking ref = "+b_ref,font='Arial 12 bold', fg='blue').grid(row=7,column=1)
                Label(fr,text="name = " + name, font='Arial 12 bold', fg='blue').grid(row=7, column=2)
                Label(fr,text="gender = " + gen, font='Arial 12 bold', fg='blue').grid(row=8, column=1)
                Label(fr,text="no of seats = " + str(seat), font='Arial 12 bold', fg='blue').grid(row=8, column=2)
                Label(fr,text="age = " + str(age), font='Arial 12 bold', fg='blue').grid(row=9, column=1)
                Label(fr,text="booked on = " + book_date, font='Arial 12 bold', fg='blue').grid(row=9, column=2)
                Label(fr,text="travel date = " + travel_date, font='Arial 12 bold', fg='blue').grid(row=10, column=1)
                Label(fr,text="fare = " + str(fare), font='Arial 12 bold', fg='blue').grid(row=10, column=2)
                Label(fr,text="total fare = " + str(fare*seat), font='Arial 12 bold', fg='blue').grid(row=11, column=1)
